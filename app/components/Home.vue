<template>
  <Page :actionBarHidden="true" >
    <GridLayout>
      <WebView src="https://maizbistro.makeidpro.com"
          @loadStarted="onWebViewNavigation" />
    </GridLayout>
  </Page>
</template>
  ...
  export default Vue.extend({
    ...
    methods:{
          onWebViewNavigation(args:any) {
            console.log('arg', args.url)
      const url = args.url;
      if (url.startsWith("https://guillermo.fitelven.com.ve/login")) {
        console.log("Navigating to login page");
        openUrl("https://guillermo.fitelven.com.ve/build/auth/login");
